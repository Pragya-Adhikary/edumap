...
<body>
    ...
    <header>
        <h1 style="font-size: 70px; color: #3E5879; ">EDUMAP NEPAL</h1>
        <p class="moto">"Mapping Unreached Schools"</p>
    </header>
        <section class="container">
            <h2 style="color: black; font-weight:bold; font: size 30px;">Welcome to EduMap Nepal</h2>
    ...
    <div class="container2">
        <div class="center-image">
            <img src="school.jpg" alt="Education for All">
  ...
  <footer>
        <p>&copy; 2025 EduMap Nepal. All rights reserved.</p>
    </footer>  
</body>
</html>
